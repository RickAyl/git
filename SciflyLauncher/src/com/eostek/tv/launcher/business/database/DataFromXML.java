...
public class DataFromXML {
    ...
    public static final String METROINFO_TAG_NET = "net";

    public static final String METROINFO_TAG_HIDE = "hide";

    public static final String METROINFO_TAG_MOVE_TYPE = "MoveType";

    public static final String METROINFO_TAG_POSITION_ID = "positionID";
        ...
        while (eventType != XmlPullParser.END_DOCUMENT) {
            switch (eventType) {
                ...
                case XmlPullParser.START_TAG:
                    ...
                    }else if (parser.getName().equals(METROINFO_TAG_NET)) {
                        String text = parser.nextText();
                        info.setNet(Integer.parseInt(text == null ? "0" : text));
                    } else if (parser.getName().equals(METROINFO_TAG_HIDE)) {
                        String text = parser.nextText();
                        info.setHide(Integer.parseInt(text == null ? "0" : text));
                    } else if (parser.getName().equals(METROINFO_TAG_MOVE_TYPE)) {
                        String text = parser.nextText();
                        info.setMoveType(Integer.parseInt(text == null ? "0" : text));
                    } else if (parser.getName().equals(METROINFO_TAG_POSITION_ID)) {
                        String text = parser.nextText();
                        info.setPositionId(Integer.parseInt(text == null ? "-1" : text));
                    }
