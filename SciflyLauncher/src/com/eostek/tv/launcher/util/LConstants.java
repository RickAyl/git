...
public final class LConstants {
    ...
    public static final int SETSMALLSCALE_MESSAGE = 1216;
    ...
    public static final int CIBN_ITEM_APK = 500;
    ...
    public static final int APP_HIDE = 1;
    
    public static final int APP_MAX_NUM = 89;

    public static final String SCIFLY_VIDEO = "com.eostek.scifly.video";
    
    public static final String SCIFLY_91Q = "com.i91q.video";
    ...
    public static final int TXT_SIZE_NORMAL = 25;

    public static final int TXT_SIZE_OTHER = 19;
    
    public static final int APP_ROW_NUM = 3;
    ...
    public static final String PKG_DEVICEMANAGER = "com.eostek.scifly.devicemanager";

    public static final String CLS_DEVICEMANAGER = "com.eostek.scifly.devicemanager.DeviceManagerActivity";

    public static final String PKG_MEDIABROWSER = "com.eostek.mediabrowser";

    public static final String CLS_MEDIABROWSER = "com.eostek.mediabrowser.MainActivity";
    
    public static final String CLS_ADD_ACTIVITY = "com.eostek.tv.launcher.ui.view.AppAddActivity";
    
    public static final String PKG_DOWNLOADMANAGER = "com.android.providers.downloads.ui";
    ...
    public final static String FEATURE_BLL_828 = "EOS0MUJIBLL0MP00";
    
    public final static String FEATURE_638 = "EOS0MNET0000TV00";
    
    public final static String FEATURE_LX828 = "EOS0MUJILX00MP00";
    
    public static final int LSGAME_REGIST = 200;
    
    public static final int REFRESH_LISTVIEW_ITEM = 20000;
