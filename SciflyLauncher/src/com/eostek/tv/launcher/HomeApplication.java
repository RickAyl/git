...
public class HomeApplication extends Application {
    ...
    public void onCreate() {
    	Log.e("ahri", "HomeApplication  onCreate");
    ...
    private static boolean isHaveTV() {
    	Log.e("ahri", "HomeApplication  isHaveTV");
        ...
        if (LConstants.PLATFORM_DANGLE.equals(board)) {
        	...
        	Log.e("ahri", "PLATFORM_TV");
            shouldAddTView = true;
            String country = UIUtil.getLanguage();
            Log.e("ahri", "country = " + country);
            if (country.equals("zh-cn")) {
            	defaultXml = R.xml.page_default;
            } else if (country.equals("zh-tw")) {
            	defaultXml = R.xml.page_default_tw;
            } else {
            	defaultXml = R.xml.page_default_en;
            }
